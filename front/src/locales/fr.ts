...
export default {
  ...
  presentation: {
    ...
    faq4Q: "C'est quoi, concrètement, une DAO et Ethereum ?",
    faq4A: "Une DAO (« organisation autonome décentralisée ») est un peu comme un règlement intérieur numérique : plutôt que d'être notées sur un tableur que quelqu'un pourrait modifier en douce, les décisions de l'asso sont enregistrées sur un registre partagé que personne ne peut trafiquer après coup — chaque vote et chaque dépense reste visible et vérifiable par tout le monde, pour toujours. Ethereum est le réseau informatique qui héberge ce registre, et l'ETH est juste le petit carburant qui sert à payer le minuscule coût d'y écrire une ligne — un peu comme un timbre pour poster une lettre.",
    faq5Q: "Pourquoi Base, et pourquoi pas rester sur Ethereum directement ?",
    faq5A: "Écrire sur Ethereum coûte un petit quelque chose à chaque fois (voir la question au-dessus) — et selon l'affluence du réseau, ce coût peut parfois devenir cher, jusqu'à plusieurs dizaines d'euros par vote. Base est une extension d'Ethereum, pensée pour rendre cette écriture quasi gratuite, tout en gardant exactement le même carburant (l'ETH) — pas une monnaie inventée pour l'occasion. On l'a choisie parce qu'elle facilite l'accès pour un membre qui n'a jamais touché à ça, pas pour une raison technique compliquée.",
    faq6Q: "Un compte bancaire associatif classique n'aurait pas suffi ?",
    faq6A: "Un compte associatif classique coûte 3 à 7€ par mois de frais de tenue de compte selon les banques — un montant fixe que l'association doit anticiper et couvrir chaque année via les cotisations, que l'activité soit forte ou nulle, et le compte peut même être fermé par la banque en cas d'inactivité prolongée. Sur la DAO, il n'y a rien à anticiper ni à mutualiser à l'avance : chaque action (voter, candidater, dépenser) coûte quelques centimes, payés directement par le membre qui agit, au moment où il agit. Le fonctionnement se finance en direct, à l'usage — pas via une réserve collective calculée en prévision des frais de l'année.",
  ...
  governance: {
    dao: {
      ...
      proposeExpenseHelper: "Cette proposition engage la trésorerie du groupe et sera soumise au vote des Loups.",
      beneficiaryLabel: "Bénéficiaire",
      beneficiaryErrorInvalid: "Adresse invalide.",
      amountLabel: "Montant",
      amountPlaceholder: "Montant en ETH",
      amountErrorEmpty: "Le montant doit être supérieur à 0.",
      reasonLabel: "Motif",
      reasonPlaceholder: "Motif",
      reasonErrorEmpty: "Le motif est requis.",
