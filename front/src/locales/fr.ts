...
export default {
  ...
  presentation: {
    ...
    faq6A: "Un compte associatif classique coûte 3 à 7€ par mois de frais de tenue de compte selon les banques, prélevés que l'association soit active ou non — et peut être fermé par la banque en cas d'inactivité prolongée. Sur la DAO, il n'y a aucun abonnement : on ne paie qu'au moment d'une action réelle (voter, candidater, dépenser), pour quelques centimes chacune. Résultat : même avec une activité normale, on reste sous le coût d'un seul mois de frais bancaires pour toute une année.",
