...
const en: typeof fr = {
  ...
  presentation: {
    ...
    faq6A: "A regular association bank account costs 3 to 7€ a month in account-keeping fees depending on the bank, charged whether the association is active or not — and can be closed by the bank after prolonged inactivity. On the DAO, there's no subscription at all: you only pay at the moment of a real action (voting, applying, spending an expense), for a few cents each. Even with normal activity, the yearly total stays under the cost of a single month of bank fees.",
